...
The number of correlator matrices that we have is this:

```{r}
nrow(actual_avail$param)
```
...
The number of correlator matrices that Markus has is the following:
...
The number of correlator matrices that we were able to load is the following:

```{r}
print(target_avail$param)
print(target_filenames)
```

```{r}
print(target_avail$param)
print(actual_avail$param)
```
...
```{r}
semi_join(target_avail$param, actual_avail$param)
```
