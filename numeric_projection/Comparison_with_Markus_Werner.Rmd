...
.func <- function (param, value) {
  ...
  list(matched_up_operators = df,
       matched_up_grid = grid)
}
...
.func <- function (param, value) {
  stopifnot(nrow(value$matched_up_operators) != 1)
...
ggsave(sprintf('comparison/comparison-%s-%s.pdf', param$total_momentum_str, param$irrep), p, width = 10, height = 10)
}
