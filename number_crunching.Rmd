...
q_markus_avail_actual <- t(total_momentum / 2 - t(q_avail_actual_matrix))
...
operator_indices_path <- sprintf('%s/rho_p%d_%s_operator-indices.tsv', target_dir, sum(total_momentum^2), irrep)
